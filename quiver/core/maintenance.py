...
from quiver.core.appimage import hints_from_meta
from quiver.core.registry import AppEntry, Registry
from quiver.util import desktop, storage
from quiver.util.config import Config
from quiver.util.output import confirm
...
def scan(cfg: Config, registry: Registry) -> ScanReport:
    ...
    # icons
    from quiver.util import paths as quiver_paths
    ...
    for directory in directories:
        ...
        for path in _iter_appimage_files(directory):
            ...
            if console is not None and not adopt_all and not assume_yes:
                from quiver.util.output import is_interactive
